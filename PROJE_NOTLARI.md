...
- **Bilinen kalıcı riskler (şimdilik dokunulmadı):** `udpReceive` sürekli `reset_upside=true` gelirse restart döngüsü riski; dolumRescue mutlak 1.0 bar eşiği / tek-loop `oto_dolum` sıfırlaması / sensör bayatken sessiz atlama.
